...
`ggai` is a compiler-first R package for turning natural-language figure instructions into:
...
``` r
pkgload::load_all("/Users/xiayh/Projects/aisdk", export_all = FALSE, helpers = FALSE)
pkgload::load_all("/Users/xiayh/Projects/ggai", export_all = FALSE, helpers = FALSE)
```
...
``` r
s <- ggai(mtcars, "show distribution of mpg", mode = "session")
```
...
![Brain Development Polished Figure](demo_outputs/brain_dev_clusterprofiler_polish_best.png)

![Brain Development Plot Reader](demo_outputs/brain_dev_plot_reader_best.png)
...
- [Brain Development Explainer Showcase](docs/2026-04-25-brain-dev-explainer-showcase.md)
- [Brain Development clusterProfiler Case](docs/2026-04-25-brain-dev-clusterprofiler-case.md)
- [Generated case summary](demo_outputs/brain_dev_clusterprofiler_summary.md)
- [Plot-reader analysis](demo_outputs/brain_dev_plot_reader_analysis.md)
- [Infographic explanation](demo_outputs/brain_dev_infographic_explanation.md)
- [Story figure explanation](demo_outputs/brain_dev_story_explanation.md)
...
![Gallery Session Final](demo_outputs/gallery_session_best.png)
...
![Gallery Geyser Final](demo_outputs/gallery_geyser_best.png)
...
![Gallery Economics Final](demo_outputs/gallery_economics_best.png)
...
- The longer workflow manual is in [docs/2026-04-25-ggai-polish-workflow-manual.md](docs/2026-04-25-ggai-polish-workflow-manual.md).
- The brain-development case study is summarized in [docs/2026-04-25-brain-dev-clusterprofiler-case.md](docs/2026-04-25-brain-dev-clusterprofiler-case.md).
- The higher-level showcase that adds infographic and narrative explanation layers is in [docs/2026-04-25-brain-dev-explainer-showcase.md](docs/2026-04-25-brain-dev-explainer-showcase.md).
